...
// Cabins list already showing. The per-cabin route /inventory/cabins/[number]
// is untouched and still serves cabin detail pages.
import { useEffect } from "react";
import { useRouter } from "next/navigation";
import "../inventory.css";

export default function CabinsRedirect() {
  const router = useRouter();

  useEffect(() => {
    router.replace("/inventory/locations?view=cabins");
  }, [router]);
